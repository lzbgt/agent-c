...
static void test_runtime_json_round_trips_media_engine_fields() {
  ...
  st.rtcp_sender_reports_sent = 1;
  st.rtcp_receiver_reports_sent = 1;
  st.rtcp_receiver_report_blocks_sent = 1;
  ...
  st.rtcp_last_reported_rtp_ssrc = 0x10203040;
  st.rtcp_last_report_fraction_lost = 0;
  st.rtcp_last_report_cumulative_lost = 1;
  st.rtcp_last_report_highest_sequence = 321;
  st.rtcp_last_report_jitter = 7;
  st.rtcp_last_report_lsr = 0x12345678;
  st.rtcp_last_report_dlsr = 0x00010000;
  ...
  assert(json["rtcp_sender_reports_sent"].asInt64() == 1);
  assert(json["rtcp_receiver_reports_sent"].asInt64() == 1);
  assert(json["rtcp_receiver_report_blocks_sent"].asInt64() == 1);
  ...
  assert(json["rtcp_last_reported_rtp_ssrc"].asInt64() == 0x10203040);
  assert(json["rtcp_last_report_fraction_lost"].asInt64() == 0);
  assert(json["rtcp_last_report_cumulative_lost"].asInt64() == 1);
  assert(json["rtcp_last_report_highest_sequence"].asInt64() == 321);
  assert(json["rtcp_last_report_jitter"].asInt64() == 7);
  assert(json["rtcp_last_report_lsr"].asInt64() == 0x12345678);
  assert(json["rtcp_last_report_dlsr"].asInt64() == 0x00010000);
  ...
  assert(round_trip.rtcp_sender_reports_sent == 1);
  assert(round_trip.rtcp_receiver_reports_sent == 1);
  assert(round_trip.rtcp_receiver_report_blocks_sent == 1);
  ...
  assert(round_trip.rtcp_last_reported_rtp_ssrc == 0x10203040);
  assert(round_trip.rtcp_last_report_fraction_lost == 0);
  assert(round_trip.rtcp_last_report_cumulative_lost == 1);
  assert(round_trip.rtcp_last_report_highest_sequence == 321);
  assert(round_trip.rtcp_last_report_jitter == 7);
  assert(round_trip.rtcp_last_report_lsr == 0x12345678);
  assert(round_trip.rtcp_last_report_dlsr == 0x00010000);
