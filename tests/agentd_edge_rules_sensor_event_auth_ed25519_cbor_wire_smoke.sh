...
agentd_smoke_start "${AGENTD_BIN}" "${HOST}" "${PORT_DAEMON}" "agentd_edge_rules_sensor_event_auth_ed25519_cbor_wire_smoke" \
  --tools none
agentd_smoke_wait_health "${DAEMON_URL}"

NODE_ID="node_rule_ed_auth_cbor_1"
KID_NODE="${NODE_ID}"
...
echo "agentd_edge_rules_sensor_event_auth_ed25519_cbor_wire_smoke OK"
