...
HOST="127.0.0.1"
NAME="agentd_workflow_drr_session_weight_smoke"
...
# Expected completion prefix should reflect weight signal:
# - B must not be starved behind all A workflows
# - A should dominate early prefix (weight=2)
...
print("ok: DRR interleaving observed:", seq, tags)
PY
