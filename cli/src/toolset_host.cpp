  ...
  *out_registry = nullptr;
  ...
  if (!cfg.sessions_root_dir.empty()) {
    ...
    st = add_tool(
      ...
      "  \"order\":{\"type\":\"string\",\"description\":\"Result ordering: ranked (default), newest, or oldest. Timeline ordering only affects daily entries.\"},"
    ...
    st = add_tool(
      ...
      "  \"observed_since_utc\":{\"type\":\"string\",\"description\":\"Optional lower bound on record observed_utc.\"},"
      "  \"observed_until_utc\":{\"type\":\"string\",\"description\":\"Optional upper bound on record observed_utc.\"},"
      "  \"valid_from_since_utc\":{\"type\":\"string\",\"description\":\"Optional lower bound on record valid_from.\"},"
      "  \"valid_from_until_utc\":{\"type\":\"string\",\"description\":\"Optional upper bound on record valid_from.\"},"
      "  \"order_by\":{\"type\":\"string\",\"description\":\"Sort order: key_asc (default), updated_desc, observed_desc, or valid_from_desc.\"},"
    ...
    if (cfg.policy == HostToolsetPolicyMode::Full) {
      st = add_tool(
        ...
        "      \"sources\":{\"description\":\"Optional additional provenance strings.\",\"oneOf\":[{\"type\":\"string\"},{\"type\":\"array\",\"items\":{\"type\":\"string\"}}]},"
        "      \"supersedes\":{\"description\":\"Optional explicit predecessor refs.\",\"oneOf\":[{\"type\":\"string\"},{\"type\":\"array\",\"items\":{\"type\":\"string\"}}]},"
        "      \"observed_utc\":{\"type\":\"string\",\"description\":\"Optional observation timestamp, ISO UTC.\"},"
        "      \"valid_from\":{\"type\":\"string\",\"description\":\"Optional validity timestamp, ISO UTC.\"},"
        "      \"valid_from_utc\":{\"type\":\"string\",\"description\":\"Alias for valid_from, accepted for compatibility.\"}"
        "    },"
        "    \"required\":[\"key\",\"value\"]"
        "  }},"
