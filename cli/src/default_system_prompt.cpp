...
const char* default_host_system_prompt() {
  return
    ...
    "- If you still need to wait for a specific UI/client event (artifact rendered, client RPC result), you may call client_wait_event instead of repeating the same action in a loop.\n"
