...
- Still open: embed that shipped media-peer foundation into a first-class agentd/session runtime path instead of keeping it as an external host-side bring-up tool.
