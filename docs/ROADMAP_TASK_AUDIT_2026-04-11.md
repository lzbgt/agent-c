...
- `tests/agentd_session_voice_webrtc_peer_runtime_smoke.sh` - 3863 lines after the receiver-peer extraction plus runtime-record fixture/assertion and session-create helper extractions. Extracted helpers:
