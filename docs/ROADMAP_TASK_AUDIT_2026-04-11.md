...
- `tests/agentd_session_voice_webrtc_peer_runtime_smoke.sh` - 3974 lines after the receiver-peer extraction plus runtime-record fixture/assertion helper extractions. Extracted helpers:
