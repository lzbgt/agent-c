...
- `tests/agentd_session_voice_webrtc_peer_runtime_smoke.sh` - 3328 lines after the receiver-peer extraction plus runtime-record fixture/assertion, daemon client, daemon lifecycle, broker-client, and runtime-helper extractions. Extracted helpers:
  `tests/lib/agentd_voice_webrtc_peer_receiver.js` at 219 lines, `tests/lib/agentd_voice_webrtc_runtime_record.py` at 196 lines, `tests/lib/agentd_voice_webrtc_daemon_lifecycle.sh` at 101 lines, `tests/lib/agentd_voice_webrtc_runtime_helpers.sh` at 92 lines, `tests/lib/agentd_voice_webrtc_daemon_client.sh` at 68 lines, and `tests/lib/agentd_voice_webrtc_broker_client.sh` at 43 lines.
