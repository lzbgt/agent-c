...
- Smokes log the pins path, presence, and source (default vs env override), and emit a hint when
  pins are missing.
- Smokes warn if the pins file exists but contains no usable entries.
