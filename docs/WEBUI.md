...
- Orchestrator run detail view includes goal/role plan revision history with diff summaries, change flags, latest-change summaries, filters (including change flag keywords), JSON expanders, and copy actions.
