...
export default function useRuntimePlane(args: RuntimePlaneArgs) {
  ...
  const runtimeClientEffects = useRuntimeClientEffects({
    ...
    client: args.client,
    daemonAuth: args.daemonAuth,
    dbClientEventsData: args.dbClientEventsData,
    dbUiActionsData: args.dbUiActionsData,
    effectiveBase: args.effectiveBase,
    sessionArtifactsData: args.sessionArtifactsData,
    sessionId: args.sessionId,
    sessionSceneData: args.sessionSceneData,
