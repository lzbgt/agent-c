...
- [ ] W=8 — Finish embedded/MCU-compatible tool plugin path (ABI constraints + host/sandbox policy; draft spec added) and add Windows parity tests for plugin host limits.
