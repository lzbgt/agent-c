...
- [ ] Node consensus: replace the current host-managed helper with embedded / firmware-native adoption and add dynamic membership / recovery policy above the shipped frame + relay + managed-runtime layer.
  ...
  - 2026-04-11: durable consensus membership policies and signed membership bundles now carry immediate previous membership epoch/member-set lineage, giving partitioned or restarting nodes a bounded recovery hint for the policy transition they missed before deeper firmware-native adoption.
