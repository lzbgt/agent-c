...
- [ ] W=5 — Audio streaming foundation: define WebRTC/Opus signaling + broker relay endpoints (spec + broker relay endpoints + loopback smoke test added) and add a minimal CLI/agentd loopback smoke test for agentd participation.
