...
- [ ] W=5 — Audio streaming foundation: define WebRTC/Opus signaling + broker relay endpoints (spec drafted; broker relay endpoints added) and add a minimal CLI/agentd loopback smoke test.
