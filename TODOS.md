...
- [ ] Audio streaming: harden the shipped agentd-native WebRTC media backend after full-duplex native-plugin proof.
  - Current acceptance target (2026-04-11): native media is no longer only signaling/control glue. After the compatibility fixture slice, the remaining production hardening for the builtin native-plugin lane is provider-surface reduction plus explicit graduation criteria against the still-supported bundled browser peer.
